...
export function AdminSidebar() {
  ...
  const gestaoItems: NavItemDef[] = [
    ...
    (isAttendant || isProfessional || adminLevel === "ceo" || adminLevel === "manager") && { title: (isAttendant || adminLevel === "ceo" || adminLevel === "manager") ? "Agenda" : "Minha Agenda", url: "/admin/my-appointments", icon: ClipboardList, tourId: "sidebar-admin-my-appointments" },
