...
const toastVariants = cva(
  [
    ...
    "rounded-2xl border px-4 py-3.5 shadow-elevated",
  ...
  ],
  {
    variants: {
      variant: {
        default: "bg-card/95 border-border/60 text-foreground",
        destructive: "destructive group bg-destructive/10 border-destructive/30 text-foreground",
        success: "bg-card/95 border-border/60 text-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "group-[.destructive]:border-muted/40 group-[.destructive]:hover:bg-destructive/10",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2.5 top-2.5 rounded-lg p-1 text-foreground/40",
