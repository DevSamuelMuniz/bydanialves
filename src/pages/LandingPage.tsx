      ...
      <header className={`fixed top-0 left-0 right-0 z-50 border-b transition-all duration-300 ${scrolled ? "bg-background/95 backdrop-blur-md shadow-md border-border/60" : "glass border-border/40"}`}>
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <button onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="focus:outline-none">
            <img alt="Salão Daniella Alves" className="h-10 object-contain cursor-pointer" src="/lovable-uploads/b95347fd-0e2a-4b5b-aac9-c7e6452c22a5.png" />
          </button>
        ...
        >
          ...
          >
            <img
              ...
              className="max-h-[85vh] max-w-full rounded-2xl shadow-2xl object-contain select-none"
            />
            <div className="absolute top-4 left-1/2 -translate-x-1/2 bg-black/60 backdrop-blur-sm rounded-full px-4 py-1.5 text-white text-xs font-medium">
              {lightboxIndex + 1} / {galleryUniqueImages.length}
            </div>
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-2 px-4">
            {galleryUniqueImages.map((src, i) => (
              <button
                ...
                className={`h-12 w-16 rounded-lg overflow-hidden border-2 transition-all shrink-0 ${i === lightboxIndex ? "border-primary scale-110" : "border-white/20 opacity-60 hover:opacity-100"}`}
              >
                <img src={src} alt="" className="w-full h-full object-cover" />
              </button>
            ))}
      ...
      {lightboxOpen && lightboxIndex !== null && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={closeLightbox}
              className="absolute -top-4 -right-4 h-10 w-10 rounded-full bg-background/90 border border-border/60 flex items-center justify-center hover:bg-background transition-colors shadow-lg"
              aria-label="Fechar"
            >
              <ChevronRight className="h-4 w-4 rotate-45" />
            </button>
            ...
            <button
              ...
              className="absolute -left-5 md:-left-14 h-12 w-12 rounded-full bg-background/90 border border-border/60 flex items-center justify-center hover:bg-background transition-colors shadow-lg"
            ...
            <button
              ...
              className="absolute -right-5 md:-right-14 h-12 w-12 rounded-full bg-background/90 border border-border/60 flex items-center justify-center hover:bg-background transition-colors shadow-lg"
